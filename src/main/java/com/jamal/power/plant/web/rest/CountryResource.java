...
import com.jamal.power.plant.service.CountryService;
import com.jamal.power.plant.web.rest.errors.BadRequestAlertException;
import com.jamal.power.plant.service.dto.CountryDTO;
...
/**
 * REST controller for managing {@link com.jamal.power.plant.domain.Country}.
 */
@RestController
@RequestMapping("/api")
